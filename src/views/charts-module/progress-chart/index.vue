 ...
 * @LastEditors: Chenyt
 * @LastEditTime: 2020-10-23 16:44:02
--> 
<template>
<div class="charts-box">
  <y-title content="半圆进度条" />
  <canvas id="mountNode" width="350" height="260"></canvas>
</div>
</template>
<script>
import F2 from "@antv/f2/lib/index-all"
export default {
  name: "charts-progress",
  data(){
    return {
    }
  },
  ...
  methods: {
    ...
    drawCharts(){
      ...
      chart.guide().html({
        position: ["50%", "80%"],
        html: '<div style="width: 120px;color: #fff;white-space: nowrap;text-align:center;">' + '<p style="font-size: 18px;margin:0;">本月进度</p>' + '<p id="text" ref="text" style="font-size: 48px;margin:0;font-weight: bold;">0</p>' + "</div>"
      })
      chart.render()
    }
